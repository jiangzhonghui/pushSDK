...
public class PushService {
	private String appkey = "55c1d35c67e58e6a4d001959";
	private String appMasterSecret = "9mt2vbouayvmfygf3ixdybtiov4xmdz3";
	...
	public void sendAndroidBroadcast(String title,String message) throws Exception {
	...
	public void sendIOSBroadcast(String message) throws Exception {
		IOSBroadcast broadcast = new IOSBroadcast();
		broadcast.setAppMasterSecret(appMasterSecret);
		broadcast.setPredefinedKeyValue("appkey", this.appkey);
		broadcast.setPredefinedKeyValue("timestamp", this.timestamp);

		broadcast.setPredefinedKeyValue("alert", message);
	...
	public void sendIOSCustomizedcast() throws Exception {
		...
		// TODO Set your alias_type here
		customizedcast.setPredefinedKeyValue("alias_type", "xx");
		customizedcast.setPredefinedKeyValue("alert", "IOS 个�?�化测试");
	...
	public void sendIOSFilecast() throws Exception {
		...
		// TODO upload your device tokens, and use '\n' to split them if there are multiple tokens 
		filecast.uploadContents("aa"+"\n"+"bb");
		filecast.setPredefinedKeyValue("alert", "IOS 文件播测�?");
	...
	public static void main(String[] args) {
		...
		PushService demo = new PushService("your appkey", "the app master secret");
		try {
